...
<body>
    ...
    <div class="pagina">
        ...
        <div class="tab" ondragover="permettiDrop(event)" draggable="false">
            <div class="colonna" ondrop="drop(event)" id="1" ondragover="permettiDrop(event)">
                <h3 class="titolo">Da Fare</h3>
            </div>
            <div class="colonna" ondrop="drop(event)" id="2" ondragover="permettiDrop(event)">
                <h3 class="titolo">In Esecuzione</h3>
            </div>
            <div class="colonna" ondrop="drop(event)" id="3" ondragover="permettiDrop(event)">
                <h3 class="titolo">Fatto</h3>
            </div>
            <div class="colonna" ondrop="drop(event)" id="4" ondragover="permettiDrop(event)">
        ...
        <script>
            ...
            function drop(event) {
                ...
                if (colonnaRilascio!=null) {
                    ...
                    if (parseInt(colonnaRilascio.id) > parseInt(idColonnaCorrente)) {
